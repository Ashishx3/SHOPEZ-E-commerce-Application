...
const Navbar = () => {
    ...
    return (
        <nav className="fixed w-full z-50 bg-red-600 shadow-md py-3">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        <Link
                            to="/cart"
                            className="flex items-center space-x-2 text-white hover:text-indigo-200 transition-colors relative"
                        >
                            ...
                            <div className="flex flex-col space-y-4 mt-4">
                                ...
                                {user ? (
                                    <>
                                        ...
                                        <button
                                            onClick={handleLogout}
                                            className="flex items-center w-full space-x-3 text-red-600 font-medium"
                                        >
